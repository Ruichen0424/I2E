...
############################################## Basic Settings #################################################################
parser.add_argument('-bz', '--batch_size', type=int, default=128, help='batch size')
...
parser.add_argument('-n', '--name', type=str, default='sewnet18', help='experiment name')
...
############################################## Training Settings #############################################################
parser.add_argument('-e', '--epochs', type=int, default=256, help='num of training epochs')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.resume:
        if os.path.isfile(args.resume):
            ...
            assert args.start_epoch == checkpoint['epoch'] + 1, "Start epoch should be the same as the checkpoint epoch"
