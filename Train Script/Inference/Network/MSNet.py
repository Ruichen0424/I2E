...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000, zero_init=False, ratio=0.12, shuffle=[4, 5, 6, 7, 0, 1, 2, 3]):
        super().__init__()
        self.inplanes = 64
        
        self.i2e = I2E(ratio=ratio, shuffle=shuffle)
