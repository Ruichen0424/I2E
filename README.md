...
If you require raw event stream data, we strongly encourage using the code provided in `./Dataset Transformation` to generate it yourself, as generation is significantly faster than downloading.
The `./Dataset Transformation` folder contains the generation code for all I2E datasets.
